...
Extract Inlined Constant HRmult => "Data.ByteString.Lazy.zipWith (*)".
Parameter HRopp : HR -> HR.
Extract Inlined Constant HRopp => "Data.ByteString.Lazy.(*-1)".
Parameter HRlt : HR -> HR -> Prop.
Extract Inlined Constant HRlt => "Data.ByteString.Lazy.(<)".
(*Parameter HRinv : HR -> HR.*)
(*Extract Inlined Constant HRinv => *)
End Rext.
Extraction Rext.
